...
const PatientPersonalParticulars = () => {
  ...
  const [seeMedicalHostory, setSeeMedicalhistory] = useState(false);
  const [addPatient, setAddPatient] = useState(false);
  const [medicalHostoryDetails, setMedicalHistoryDetails] = useState("");
  ...
  return (
    <>
      ...
      {updateData && (
        ...
        <MedicalHistory
          open={seeMedicalHostory}
          setOpen={setSeeMedicalhistory}
          medicalHostoryDetails={medicalHostoryDetails}
        />
